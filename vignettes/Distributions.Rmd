...
1. Named known distributions (Normal, Poisson currently supported.)
...
```{r eval = F}
updatedIndicatorData <- setIndicatorValues(updatedIndicatorData, areaId = 7041, year = 2018, distribution = "Normal", distParams = list("mean" = 0.7, "sd" = 0.15))
